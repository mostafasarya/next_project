...
export const defaultButtonStyles: ButtonStyles = {
  ...
  fontWeight: '500',
  isBold: false,
  backgroundColor: '#f3d2c7',
  backgroundType: 'solid',
  gradientStart: '#f3d2c7',
  gradientEnd: '#e8c4b8',
          ...
          {activeTab === 'icon' && (
            <div className="collapsible-content">
              ...
              <div className="drawer-range-container">
                <div className="drawer-range-label">
                  <span>Icon Size</span>
                  <span className="drawer-range-value">{buttonStyles.iconSize}px</span>
                </div>
                <input
                  type="range"
                  min="12" max="32" value={buttonStyles.iconSize}
                  onChange={(e) => updateButtonStyle('iconSize', Number(e.target.value))}
                  className="drawer-range" onClick={(e) => e.stopPropagation()}
                />
              </div>
              ...
              {/* Icon Color */}
              <div className="drawer-form-group">
                <label className="drawer-form-label">Icon Color</label>
                <input
                  type="color"
                  value={buttonStyles.iconColor}
                  onChange={(e) => updateButtonStyle('iconColor', e.target.value)}
                  className="drawer-color-input" onClick={(e) => e.stopPropagation()}
                />
              </div>
...
// Helper function to create button styles with elegant defaults
export const createButtonStyles = (overrides: Partial<ButtonStyles> = {}): ButtonStyles => {
  return {
    ...defaultButtonStyles,
    ...overrides
  };
