  ...
  return (
    <div className={`products-grid-container ${className}`}>
      ...
      <div 
        ...
        className={`collection-products-grid ${viewMode === 'horizontal' ? 'horizontal-view' : ''}`}
        style={viewMode === 'grid' ? {
          gridTemplateColumns: gridLayout.columns === 'auto-fill' 
            ? `repeat(auto-fill, minmax(${gridLayout.minColumnWidth * scaleFactor}px, 1fr))`
